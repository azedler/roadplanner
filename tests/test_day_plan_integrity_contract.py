...
frontend = (
    (ROOT / "frontend" / "roadplanner-panel.js").read_text(encoding="utf-8")
    + (ROOT / "frontend" / "features" / "decisions-integrity.js").read_text(encoding="utf-8")
    + (ROOT / "frontend" / "features" / "trip-day-stop.js").read_text(encoding="utf-8")
)
