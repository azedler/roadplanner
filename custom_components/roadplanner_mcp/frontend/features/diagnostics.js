...
export const diagnosticsMixin = {
  _renderDiagnostics() {
    ...
    return `
      ...
      <details data-section="diagnostics-film" class="panel-card diagnostics-accordion">
      ...
      <details data-section="diagnostics-music" class="panel-card diagnostics-accordion">
      ...
      <details data-section="diagnostics-video" class="panel-card diagnostics-accordion">
      ...
      <details data-section="diagnostics-renderer" class="panel-card diagnostics-accordion">
